...
public class Camera2Engine extends CameraBaseEngine implements
    ...
    protected List<Size> getPreviewStreamAvailableSizes() {
        ...
        try {
            ...
            Log.e("CameraError", "CameraAccessException: Unable to access camera.", e);
        } catch (Exception e) {
            Log.e("CameraError", "Unexpected error while getting preview sizes.", e);
        }
    ...
    protected List<Size> getFrameProcessingAvailableSizes() {
        ...
        try {
            ...
            if (sizes == null || sizes.length == 0) {
                Log.e("CameraError", "No available output sizes for frame processing.");
                return candidates;
            }
            ...
            Log.e("CameraError", "Unexpected error while getting frame processing sizes.", e);
            return candidates;
        }
                ...
                public void onDisconnected(@NonNull CameraDevice camera) {
                    ...
                    try {
                        ...
                        if (!task.getTask().isComplete()) {
                            ...
                            LOG.i("CameraDevice.StateCallback reported disconnection." + exception);
                            //   throw exception;
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
    ...
    protected Task<Void> onStartBind() {
        ...
        if (outputClass == SurfaceHolder.class) {
            ...
            try {
                ...
                Log.e("ERROR_LOG", "Đã xảy ra lỗi: " + e.getMessage(), e);
                e.printStackTrace();
            }
        } else {
